...
function AccountInfo() {
  ...
  if (!currentUser) {
    return (
      <section className='account-info-container2'>
        <h1>Welcome User!</h1>
        <img className='login-kitten' alt='small cute kitten with ball of yarn' src={require('../components/images/cat-with-ball-of-yarn-by-Vexels.png')} />
